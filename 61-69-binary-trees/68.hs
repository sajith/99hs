...
Preorder and inorder sequences of binary trees. We consider binary
trees with nodes that are identified by single lower-case letters, as
in the example of problem P67.
...
c) If both the preorder sequence and the inorder sequence of the nodes
